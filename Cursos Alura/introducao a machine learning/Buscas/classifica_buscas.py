from carrega_dados_csv_categoricos import carregar_buscas
...
dados = carregar_buscas()

'''
X, Y, X_teste, Y_teste = use_training_set(dados)
#Dividindo os dados
X, Y, X_teste, Y_teste = hold_out(dados, 0.7)
teste_criado_na_mao_X = [[1,0,1],[0,1,0], [1,0,0], [1,1,1]]
'''
X, Y, X_teste, Y_teste = hold_out(dados, porcentagem)
