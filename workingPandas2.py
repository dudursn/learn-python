...
def geraTamanhoDaCamisa(dados):
    ...
    resultados= []
    writer1 = pd.ExcelWriter('Tamanho_da_Camisa2.xlsx')
...
def mineraDados(dados):
    ...
    date_format = "%m/%d/%Y"
    writer = pd.ExcelWriter('Inscricoes_Olimpiadas_TCE_MA2.xlsx')

    for modalidade in modalidades:
        tipos = ["Nome","Gênero","Setor/Empresa","Idade"]
        resultados= []
        k = 0
